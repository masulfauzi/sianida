                        ...
                        <tbody>
                            ...
                            @forelse ($data as $item)
                                <tr>
									...
									<td>{{ $item->id_pesertadidik }}</td>
									<td>{{ $item->id_statuskehadiran }}</td>
									<td>{{ $item->catatan }}</td>
									
                                    <td>
										{!! button('presensi.show','', $item->id) !!}
										{!! button('presensi.edit', $title, $item->id) !!}
                                        {!! button('presensi.destroy', $title, $item->id) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>
