                                ...
                                <tbody>
                                    ...
                                    @forelse ($siswa as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="form-control" type="text" name="catatan[{{ $no }}]"
                                                    value="{{ $item->catatan }}"></td>
                                            <td>
                                                <input @if ($item->id_statuskehadiran == "5cb7e9bc-79dc-4deb-8bd2-77930dbca9a3")
                                                checked="checked" @endif value="5cb7e9bc-79dc-4deb-8bd2-77930dbca9a3"
                                                    type="radio" name="id_statuskehadiran[{{ $no }}]"> Hadir
                                                <input @if ($item->id_statuskehadiran == "594e4276-34ef-4c87-9575-6aeec8e62fa9")
                                                checked="checked" @endif value="594e4276-34ef-4c87-9575-6aeec8e62fa9"
                                                    style="margin-left: 15px;" type="radio"
                                                    name="id_statuskehadiran[{{ $no }}]"> Sakit
                                                <input @if ($item->id_statuskehadiran == "79bab833-e4f7-4ca9-872e-ee17acfb02c2")
                                                checked="checked" @endif value="79bab833-e4f7-4ca9-872e-ee17acfb02c2"
                                                    style="margin-left: 15px;" type="radio"
                                                    name="id_statuskehadiran[{{ $no }}]"> Ijin
                                                <input @if ($item->id_statuskehadiran == "ddce3af2-26e6-4827-af85-f618523cf83e")
                                                checked="checked" @endif value="ddce3af2-26e6-4827-af85-f618523cf83e"
                                                    style="margin-left: 15px;" type="radio"
                                                    name="id_statuskehadiran[{{ $no }}]"> Alfa
                                            </td>
                                        </tr>
                                        @php $no++; @endphp
                                    @empty
