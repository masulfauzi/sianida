                        ...
                        <div class="card border mb-3">
                            <div class="card-body">
                                ...
                                <div class="btn-group" role="group" aria-label="Skor Pembelajaran">
                                    <input type="radio" class="btn-check" name="pembelajaran" id="pembelajaran_0" value="0" autocomplete="off" {{ old('pembelajaran') == 0 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="pembelajaran_0">0</label>
                                    <input type="radio" class="btn-check" name="pembelajaran" id="pembelajaran_1" value="1" autocomplete="off" {{ old('pembelajaran') == 1 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="pembelajaran_1">1</label>
                                    <input type="radio" class="btn-check" name="pembelajaran" id="pembelajaran_2" value="2" autocomplete="off" {{ old('pembelajaran') == 2 ? 'checked' : '' }}>
