                        ...
                        <div class="card border mb-3">
                            <div class="card-body">
                                ...
                                <div class="btn-group" role="group" aria-label="Skor Identitas">
                                    ...
                                    <input type="radio" class="btn-check" name="identitas" id="identitas_3" value="3" autocomplete="off" {{ old('identitas', $verifikasirpp->identitas) == 3 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="identitas_3">3</label>
                                    <input type="radio" class="btn-check" name="identitas" id="identitas_4" value="4" autocomplete="off" {{ old('identitas', $verifikasirpp->identitas) == 4 ? 'checked' : '' }}>
                        ...
                        <div class="card border mb-3">
                            <div class="card-body">
                                ...
                                <div class="btn-group" role="group" aria-label="Skor Tujuan Pembelajaran">
                                    ...
                                    <input type="radio" class="btn-check" name="tp" id="tp_3" value="3" autocomplete="off" {{ old('tp', $verifikasirpp->tp) == 3 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="tp_3">3</label>
                                    <input type="radio" class="btn-check" name="tp" id="tp_4" value="4" autocomplete="off" {{ old('tp', $verifikasirpp->tp) == 4 ? 'checked' : '' }}>
                        ...
                        <div class="card border mb-3">
                            <div class="card-body">
                                ...
                                <div class="btn-group" role="group" aria-label="Skor Pembelajaran">
                                    <input type="radio" class="btn-check" name="pendahuluan" id="pendahuluan_0" value="0" autocomplete="off" {{ old('pendahuluan', $verifikasirpp->pendahuluan) == 0 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="pendahuluan_0">0</label>
                                    <input type="radio" class="btn-check" name="pendahuluan" id="pendahuluan_1" value="1" autocomplete="off" {{ old('pendahuluan', $verifikasirpp->pendahuluan) == 1 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="pendahuluan_1">1</label>
                                    <input type="radio" class="btn-check" name="pendahuluan" id="pendahuluan_2" value="2" autocomplete="off" {{ old('pendahuluan', $verifikasirpp->pendahuluan) == 2 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="pendahuluan_2">2</label>
                                    <input type="radio" class="btn-check" name="pendahuluan" id="pendahuluan_3" value="3" autocomplete="off" {{ old('pendahuluan', $verifikasirpp->pendahuluan) == 3 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="pendahuluan_3">3</label>
                                    <input type="radio" class="btn-check" name="pendahuluan" id="pendahuluan_4" value="4" autocomplete="off" {{ old('pendahuluan', $verifikasirpp->pendahuluan) == 4 ? 'checked' : '' }}>
                                ...
                                <div class="btn-group" role="group" aria-label="Skor Inti">
                                    <input type="radio" class="btn-check" name="inti" id="inti_0" value="0" autocomplete="off" {{ old('inti', $verifikasirpp->inti) == 0 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="inti_0">0</label>
                                    <input type="radio" class="btn-check" name="inti" id="inti_1" value="1" autocomplete="off" {{ old('inti', $verifikasirpp->inti) == 1 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="inti_1">1</label>
                                    <input type="radio" class="btn-check" name="inti" id="inti_2" value="2" autocomplete="off" {{ old('inti', $verifikasirpp->inti) == 2 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="inti_2">2</label>
                                    <input type="radio" class="btn-check" name="inti" id="inti_3" value="3" autocomplete="off" {{ old('inti', $verifikasirpp->inti) == 3 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="inti_3">3</label>
                                    <input type="radio" class="btn-check" name="inti" id="inti_4" value="4" autocomplete="off" {{ old('inti', $verifikasirpp->inti) == 4 ? 'checked' : '' }}>
                                ...
                                <div class="btn-group" role="group" aria-label="Skor Penutup">
                                    <input type="radio" class="btn-check" name="penutup" id="penutup_0" value="0" autocomplete="off" {{ old('penutup', $verifikasirpp->penutup) == 0 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="penutup_0">0</label>
                                    <input type="radio" class="btn-check" name="penutup" id="penutup_1" value="1" autocomplete="off" {{ old('penutup', $verifikasirpp->penutup) == 1 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="penutup_1">1</label>
                                    <input type="radio" class="btn-check" name="penutup" id="penutup_2" value="2" autocomplete="off" {{ old('penutup', $verifikasirpp->penutup) == 2 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="penutup_2">2</label>
                                    <input type="radio" class="btn-check" name="penutup" id="penutup_3" value="3" autocomplete="off" {{ old('penutup', $verifikasirpp->penutup) == 3 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="penutup_3">3</label>
                                    <input type="radio" class="btn-check" name="penutup" id="penutup_4" value="4" autocomplete="off" {{ old('penutup', $verifikasirpp->penutup) == 4 ? 'checked' : '' }}>
                        ...
                        <div class="card border mb-3">
                            <div class="card-body">
                                ...
                                <div class="btn-group" role="group" aria-label="Skor Asesmen">
                                    ...
                                    <input type="radio" class="btn-check" name="assesmen" id="assesmen_3" value="3" autocomplete="off" {{ old('assesmen', $verifikasirpp->assesmen) == 3 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="assesmen_3">3</label>
                                    <input type="radio" class="btn-check" name="assesmen" id="assesmen_4" value="4" autocomplete="off" {{ old('assesmen', $verifikasirpp->assesmen) == 4 ? 'checked' : '' }}>
                        ...
                        <div class="card border mb-3">
                            <div class="card-body">
                                ...
                                <div class="btn-group" role="group" aria-label="Skor Lampiran">
                                    ...
                                    <input type="radio" class="btn-check" name="lampiran" id="lampiran_3" value="3" autocomplete="off" {{ old('lampiran', $verifikasirpp->lampiran) == 3 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="lampiran_3">3</label>
                                    <input type="radio" class="btn-check" name="lampiran" id="lampiran_4" value="4" autocomplete="off" {{ old('lampiran', $verifikasirpp->lampiran) == 4 ? 'checked' : '' }}>
