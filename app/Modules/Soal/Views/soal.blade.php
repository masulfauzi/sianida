                    ...
                    <table class="table" id="table1">
                        ...
                        <tbody>
                            ...
                            @forelse ($data as $item)
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td>{{ $item->id_ujiansekolah }}</td>
									<td>{{ $item->id_jenissoal }}</td>
									<td>{{ $item->no_soal }}</td>
									<td>{{ $item->soal }}</td>
									<td>{{ $item->gambar }}</td>
									<td>{{ $item->opsi_a }}</td>
                                    ...
                                    <td>
										{!! button('soal.show','', $item->id) !!}
										{!! button('soal.edit', $title, $item->id) !!}
                                        {!! button('soal.destroy', $title, $item->id) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>
