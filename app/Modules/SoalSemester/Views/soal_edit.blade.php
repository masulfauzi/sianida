...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            ...
            @include('SoalSemester::soal_nomor')
            <div class="card-body">
                @include('include.flash')
                <form class="form form-horizontal" action="{{ route('soalsemester.update', $soal->id) }}" method="POST" enctype="multipart/form-data">
                    <div class="form-body">
                        @csrf 
                        @method('patch')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                @if ($soal->gambar != '')
                                    ...
                                    <a href="{{ route('soalsemester.hapus_gambar.destroy', [$soal->id, 'gambar']) }}" style="color: red"><i class="bi bi-x-circle"></i> Hapus Gambar</a>
                                @else
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                @if ($soal->gambar_a != '')
                                    ...
                                    <a href="{{ route('soalsemester.hapus_gambar.destroy', [$soal->id, 'gambar_a']) }}" style="color: red"><i class="bi bi-x-circle"></i> Hapus Gambar</a>
                                @else
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                @if ($soal->gambar_b != '')
                                    ...
                                    <a href="{{ route('soalsemester.hapus_gambar.destroy', [$soal->id, 'gambar_b']) }}" style="color: red"><i class="bi bi-x-circle"></i> Hapus Gambar</a>
                                @else
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                @if ($soal->gambar_c != '')
                                    ...
                                    <a href="{{ route('soalsemester.hapus_gambar.destroy', [$soal->id, 'gambar_c']) }}" style="color: red"><i class="bi bi-x-circle"></i> Hapus Gambar</a>
                                @else
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                @if ($soal->gambar_d != '')
                                    ...
                                    <a href="{{ route('soalsemester.hapus_gambar.destroy', [$soal->id, 'gambar_d']) }}" style="color: red"><i class="bi bi-x-circle"></i> Hapus Gambar</a>
                                @else
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                @if ($soal->gambar_e != '')
                                    ...
                                    <a href="{{ route('soalsemester.hapus_gambar.destroy', [$soal->id, 'gambar_e']) }}" style="color: red"><i class="bi bi-x-circle"></i> Hapus Gambar</a>
                                @else
