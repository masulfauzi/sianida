    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-9">
                        <form action="{{ route('instrumenpenilaian.index') }}" method="get">
                    ...
                    <div class="col-3">  
						{!! button('instrumenpenilaian.create', $title) !!}  
                    </div>
                </div>
                            ...
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td>
										...
										{{-- {!! button('instrumenpenilaian.edit', $title, $item->id) !!} --}}
                                        {!! button('instrumenpenilaian.destroy', $title, $item->id) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>
