        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form form-horizontal" action="{{ route('pesan.store') }}" method="POST">
                        <div class="form-body">
                            @csrf
...
@section('page-js')
    <script src="{{ asset('assets/js/extensions/whatsappeditor/src/js/whatsapp-editor.js') }}"></script>
@endsection

@section('inline-js')
    <script>
        $(".element").whatsappEditor();
