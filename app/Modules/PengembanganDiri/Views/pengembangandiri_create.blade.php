    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form form-horizontal" action="{{ route('pengembangandiri.store') }}" method="POST" enctype="multipart/form-data">
                    <div class="form-body">
                        @csrf 
                        ...
                        <div class="offset-md-3 ps-2">
                            ...
                            <a href="{{ route('pengembangandiri.index') }}" class="btn btn-secondary">Batal</a>
                        </div>
                  </div>
                </form>
            </div>
