    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form form-horizontal" action="{{ route('nilai.index') }}" method="GET" enctype="multipart/form-data">
                    <div class="form-body">
                        {{-- @csrf  --}}
                        <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                {!! Form::select('id_semester', $semester, $selected['id_semester'], ['class' => 'form-control select2', 'required']) !!}
                                @error('id_semester')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                {!! Form::select('id_jurusan', $jurusan, $selected['id_jurusan'], ['class' => 'form-control select2', 'required']) !!}
                                @error('id_jurusan')
                                    <div class="text-danger">
                                        {{ $message }}
                                    </div>
