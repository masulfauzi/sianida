            ...
            return `
                <div class="transkrip-template">
                    <div class="header">
                        ...
                        <div style="font-size: 27px; margin: 2px 0px; line-height: 0.9; font-weight: bold;">DINAS PENDIDIKAN</div>
                        <div style="font-size: 27px; margin: 2px 0px; line-height: 0.9;"><strong>SEKOLAH MENENGAH KEJURUAN NEGERI 2 SEMARANG</strong></div>
                        <div style="font-size: 16px; margin: 2px 0px; line-height: 0.8;">Jalan Dr. Cipto Nomor 121 A, Semarang Timur, Kota Semarang, Jawa Tengah, Kode Pos 50124</div>
                        <div style="font-size: 16px; margin: 2px 0px; line-height: 0.8;">Telepon 024-8455757, Fakssimile 024-8455757, Laman https://smkn2semarang.sch.id</div>
                        <div style="font-size: 16px; margin: 2px 0px; line-height: 0.8;">Pos-el smkn2kotasemarang@gmail.com, smeansa_smg@yahoo.co.id</div>
