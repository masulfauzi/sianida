                    ...
                    <div class="col-lg-10 offset-lg-2">
                        <div class="row">
                            <div class='col-lg-2'><p>Guru</p></div><div class='col-lg-10'><p class='fw-bold'>{{ $jadwal->guru->id }}</p></div>
									...
									<div class='col-lg-2'><p>Kelas</p></div><div class='col-lg-10'><p class='fw-bold'>{{ $jadwal->kelas->id }}</p></div>
									<div class='col-lg-2'><p>Jam Mulai</p></div><div class='col-lg-10'><p class='fw-bold'>{{ $jadwal->jam_mulai }}</p></div>
									<div class='col-lg-2'><p>Jam Selesai</p></div><div class='col-lg-10'><p class='fw-bold'>{{ $jadwal->jam_selesai }}</p></div>
