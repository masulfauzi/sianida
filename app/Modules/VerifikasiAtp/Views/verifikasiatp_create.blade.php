                        ...
                        <div class="card border mb-3">
                            <div class="card-body">
                                ...
                                <div class="btn-group" role="group" aria-label="Skor CP Elemen">
                                    <input type="radio" class="btn-check" name="cp" id="cp_0" value="0" autocomplete="off" {{ old('cp') == 0 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="cp_0">0</label>
                                    <input type="radio" class="btn-check" name="cp" id="cp_1" value="1" autocomplete="off" {{ old('cp') == 1 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="cp_1">1</label>
                                    <input type="radio" class="btn-check" name="cp" id="cp_2" value="2" autocomplete="off" {{ old('cp') == 2 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="cp_2">2</label>
                                    <input type="radio" class="btn-check" name="cp" id="cp_3" value="3" autocomplete="off" {{ old('cp') == 3 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="cp_3">3</label>
                                    <input type="radio" class="btn-check" name="cp" id="cp_4" value="4" autocomplete="off" {{ old('cp') == 4 ? 'checked' : '' }}>
                        ...
                        <div class="card border mb-3">
                            <div class="card-body">
                                ...
                                <div class="btn-group mt-2" role="group" aria-label="Skor Alokasi Waktu">
                                    ...
                                    <input type="radio" class="btn-check" name="alokasi_waktu" id="alokasi_waktu_3" value="3" autocomplete="off" {{ old('alokasi_waktu') == 3 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="alokasi_waktu_3">3</label>
                                    <input type="radio" class="btn-check" name="alokasi_waktu" id="alokasi_waktu_4" value="4" autocomplete="off" {{ old('alokasi_waktu') == 4 ? 'checked' : '' }}>
                        ...
                        <div class="card border mb-3">
                            <div class="card-body">
                                ...
                                <div class="btn-group" role="group" aria-label="Skor Materi">
                                    <input type="radio" class="btn-check" name="materi" id="materi_0" value="0" autocomplete="off" {{ old('materi') == 0 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="materi_0">0</label>
                                    <input type="radio" class="btn-check" name="materi" id="materi_1" value="1" autocomplete="off" {{ old('materi') == 1 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="materi_1">1</label>
                                    <input type="radio" class="btn-check" name="materi" id="materi_2" value="2" autocomplete="off" {{ old('materi') == 2 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="materi_2">2</label>
                                    <input type="radio" class="btn-check" name="materi" id="materi_3" value="3" autocomplete="off" {{ old('materi') == 3 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="materi_3">3</label>
                                    <input type="radio" class="btn-check" name="materi" id="materi_4" value="4" autocomplete="off" {{ old('materi') == 4 ? 'checked' : '' }}>
                        ...
                        <div class="card border mb-3">
                            <div class="card-body">
                                ...
                                <div class="btn-group" role="group" aria-label="Skor Lain-Lain">
                                    <input type="radio" class="btn-check" name="metode" id="metode_0" value="0" autocomplete="off" {{ old('metode') == 0 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="metode_0">0</label>
                                    <input type="radio" class="btn-check" name="metode" id="metode_1" value="1" autocomplete="off" {{ old('metode') == 1 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="metode_1">1</label>
                                    <input type="radio" class="btn-check" name="metode" id="metode_2" value="2" autocomplete="off" {{ old('metode') == 2 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="metode_2">2</label>
                                    <input type="radio" class="btn-check" name="metode" id="metode_3" value="3" autocomplete="off" {{ old('metode') == 3 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="metode_3">3</label>
                                    <input type="radio" class="btn-check" name="metode" id="metode_4" value="4" autocomplete="off" {{ old('metode') == 4 ? 'checked' : '' }}>
