                    ...
                    <table class="table" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('ujiansemester.aksi_upload.store') }}"  method="POST" enctype="multipart/form-data">
                                        @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($data->norma_penilaian)
                                        <a href="{{ route('soalsemester.input.create', array('id_ujiansemester' => $data->id, 'no_soal' => '1')) }}" class="btn btn-primary">Input Soal</a>
                                        <button type="button" class="btn btn-success" id="btn-import-soal" data-id="{{ $data->id }}">Import Soal</button>
                                    @else
...
<!-- Modal Import Soal -->
<div class="modal fade" id="modalImportSoal" tabindex="-1" role="dialog" aria-labelledby="modalImportLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <form id="formImportSoal">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="file-import" name="file" accept=".xlsx,.xls" required>
