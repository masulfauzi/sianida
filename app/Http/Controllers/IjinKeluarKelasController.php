    ...
    public function index_guru(Request $request)
    {
        try {
            ...
            $ijinKeluarKelas = IjinKeluarKelas::where('id_guru', $id_guru)
                ...
                ->join('status_ijin', 'ijin_keluar_kelas.id_status_ijin', '=', 'status_ijin.id')
                ->select('ijin_keluar_kelas.id', 'siswa.nama as siswa_nama', 'jam_keluar_table.jam_pelajaran as jam_keluar_pelajaran', 'jam_kembali_table.jam_pelajaran as jam_kembali_pelajaran', 'jenis_ijin_keluar_kelas.jenis_ijin_keluar', 'status_ijin.status_ijin')
                ->get();
