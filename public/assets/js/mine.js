...
function printArea(elementId){
	...
	printWindow.document.write('<style>@page{size: 210mm 148mm; margin: 0;} html,body{margin:0;padding:0;width:100%;} body{font-family: Arial, sans-serif; font-size: 11pt; box-sizing:border-box; padding: 8mm;} *{box-sizing:border-box;} table{width:100%;border-collapse:collapse;} img{max-width:100%;} td{padding:2px 6px;} .center{text-align:center;} .bold{font-weight:bold;} .underline{text-decoration:underline;} hr.atas{border-top:3px solid black;} hr.bawah{border-top:1px solid black;margin-top:-8px;}</style>');
