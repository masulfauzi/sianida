		...
		<div class="col-lg-5 col-12">
			<div id="auth-left">
				...
				<form method="POST" action="{{ route('password.update') }}">
                    ...
                    <x-form-group class="position-relative has-icon-left mb-4">
                        <input type="password" class="form-control form-control-xl" placeholder="Password" name="password" required autofocus>
                        <div class="form-control-icon">
                            <i class="bi bi-shield-lock"></i>
                        </div>
                    </x-form-group>
                    <x-form-group class="position-relative has-icon-left mb-4">
                        <input type="password" class="form-control form-control-xl" placeholder="Password Confirmation" name="password_confirmation" required autofocus>
                        <div class="form-control-icon">
                            <i class="bi bi-shield-lock"></i>
                        </div>
                    </x-form-group>
