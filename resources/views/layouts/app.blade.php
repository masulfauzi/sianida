...
<body>
        ...
        <div id="main" class='layout-navbar'>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                <li class="nav-item dropdown me-1">
                                    <a class="nav-link active dropdown-toggle text-gray-700 me-3" href="#"
                                        ...
                                        <i class='bi bi-bar-chart-steps fs-4'></i> Ubah Semester Aktif
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                        <li>
                                            <h6 class="dropdown-header">Pilih Semester</h6>
                                        </li>
                                        @foreach (session('semester') as $key => $item)
                                            <li>
                                                <a class="dropdown-item" href="{{ get_semester('active_semester') == $item ? '#' : route('dashboard.change.semester', $key) }}">
                                                    @if (get_semester('active_semester') == $item) <b>{{ $item }}<i class="bi bi-check"></i></b> @else {{ $item }} @endif
                                                </a>
                                            </li>
                                        @endforeach
                                    </ul>
                                ...
                                <li class="nav-item dropdown me-1">
                                    <a class="nav-link active dropdown-toggle text-gray-700 me-3" href="#"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class='bi bi-person-lines-fill fs-4'></i> Change Role
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                        <li>
                                        ...
                                        @foreach (session('roles') as $key => $item)
                                            <li>
                                                <a class="dropdown-item" href="{{ get('active_role') == $item ? '#' : route('dashboard.change.role', $key) }}">
                                                    @if (get('active_role') == $item) <b>{{ $item }}<i class="bi bi-check"></i></b> @else {{ $item }} @endif
                                                </a>
                                            </li>
                                        @endforeach
                                    </ul>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="min-width: 11rem;">
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('profile') }}"><i class="icon-mid bi bi-person me-2"></i> My Profile</a></li>
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    ...
                    <div class="float-end">
                        <p>Crafted with <span class=""><i class="bi bi-tornado"></i> Laralag</span> by <a href="https://tugutech.net">Tugutech</a></p>
                    </div>
                </div>
            </footer>
        </div>
    ...
    <script>
        $(".select2").selectize();
        var $selectizeObj = $(".multi-select2").selectize({ maxItems: null });
